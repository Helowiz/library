...
Revision ID: e396680d777b
Revises: 
Create Date: 2025-11-22 19:38:46.113765
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('book_id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('WISHLIST', 'TBR', 'READING', 'READ', name='readingstatus'), nullable=True),
