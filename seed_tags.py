...
def seed_tags():
    ...
    genres = [
        # --- Fiction ---
        "Fantasy", "Science-Fiction", "Dystopie", "Fantastique",
        "Thriller", "Policier", "Horreur", "Romance",
        "Aventure", "Historique", "Contemporain",
        "Classique", "Humour", "Drame",
        
        # --- Jeunesse / Graphique ---
        "Young Adult", "Jeunesse", "Manga", "Comics", 
        "Bande Dessinée", "Roman Graphique",
        
        # --- Non-Fiction ---
        "Biographie", "Autobiographie", "Essai", "Développement Personnel",
        "Philosophie", "Psychologie", "Histoire", "Science",
        "Voyage", "Cuisine", "Art", "True Crime",
